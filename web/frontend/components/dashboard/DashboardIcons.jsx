...
export function IconCalendar(props) {
  return (
    <svg viewBox="0 0 24 24" {...iconProps} {...props}>
      <path d="M7 11h2v2H7v-2zm4 0h2v2h-2v-2zm4 0h2v2h-2v-2zM5 4h1V2h2v2h8V2h2v2h1a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2zm0 4v12h14V8H5z" />
    </svg>
  );
}

export function IconForms(props) {
  return (
    <svg viewBox="0 0 24 24" {...iconProps} {...props}>
      <path d="M4 6h16v2H4V6zm0 5h16v2H4v-2zm0 5h10v2H4v-2zM18 16v4l4-2-4-2z" />
    </svg>
  );
}
...
export function IconPalette(props) {
  return (
    <svg viewBox="0 0 24 24" width={120} height={120} fill="currentColor" aria-hidden {...props}>
      <path d="M12 3a9 9 0 0 0 0 18h1a2 2 0 0 0 2-2 2 2 0 0 1 2-2h1.5a2.5 2.5 0 0 0 0-5H17a2 2 0 0 1-2-2 2 2 0 0 0-2-2h-.5a2.5 2.5 0 0 0-5 0H9a2 2 0 0 1-2 2 2 2 0 0 0-2 2H4.5a2.5 2.5 0 0 0 0 5H6a2 2 0 0 1 2 2 2 2 0 0 0 2 2h1a9 9 0 0 0 3-16zM7.5 12a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm3-4a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zM12 13.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm3 3.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z" />
    </svg>
  );
}
